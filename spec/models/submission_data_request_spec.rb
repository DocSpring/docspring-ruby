...
# Unit tests for DocSpring::SubmissionDataRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DocSpring::SubmissionDataRequest do
  let(:instance) { DocSpring::SubmissionDataRequest.new }

  describe 'test an instance of SubmissionDataRequest' do
    it 'should create an instance of SubmissionDataRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(DocSpring::SubmissionDataRequest)
    end
  end
